...
| :--------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Reconoce responsabilidad ética y profesional en situaciones de ingeniería de software.       | **Cacho Seminario, Diego Alonso**<br>TB1: Para el desarrollo de la TB1, aporte creando los documentos de exposicion, reporte de participación y además prepare el reporte principal con los items anteriores para la entrega. <br><br>**###########, ###############**<br>TB1: .<br><br>**Villugas Jeronimo, Liam Anderson**<br>TB1:Para el desarrollo de la TB1, aporte con el informe inicial del trabajo. <br><br>**#######, #########**<br>TB1: .<br>Ruiz Huisa, Daniel Elias<br>: para el desarrollo del presente trabajo, revise la correcta regresion de las versiones deployadas del proyecto, a versiones estables que puedan adaptarse a otros entornos de despliegue. **Palacin Lazo, Gerardo Valentin** <br> TB1: Para el desarrollo del trabajo, logre participar en el informe apoyando en la verificación y despliegue de la información requerida de los capítulos a entregar <br>
| En la TB1, los integrantes del equipo revisaron el avance general de la entrega anterior y realizaron cambios para el funcionamiento aceptable de la aplicación.  <br><br>                                                                           |
| Emite juicios informados considerando el impacto de las soluciones de ingeniería de software en contextos globales, económicos, ambientales y sociales. | **Cacho Seminario, Diego Alonso**<br>TB1: Como primera entrega utilice las herramientas de Github y Canva para poder redactar y crear la información necesaria para el trabajo de SafeWork. <br><br>**#######, ########**<br>TB1: .<br><br>**Villugas Jeronimo, Liam Anderson**<br>TB1: Como primera entrega utilice herramientas de github y markdown para el informe para SafeWork<br><br>**##########, ########**<br> **TB1: Ruiz Huisa, Daniel Elias:** Como orimers entrega, aproveché la herramienta git, oara identificar los puntos de desarrollo clave que nos permitan desplegar nuevamente el aplicativo en posteriores entregas.  **Palacin Lazo, Gerardo Valentin** <br> TB1: Mediante la herramienta de github y commits pude documentar mi avance en el informe requerido para esta entrega. <br>| Durante la TB1, el equipo logró utilizar las herramientas apropiadas para la entrega, se uso GitHub como repositorio principal para el proyecto, Google Docs para el reporte de participación y Canva como herramienta para crear la presentación de exposición. <br><br>|
