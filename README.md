...
**Criterio:** Capacidad de reconocer responsabilidades éticas y profesionales en situaciones de ingeniería y hacer juicios informados, que deben considerar el impacto de las soluciones de ingeniería en contextos globales, económicos, ambientales y sociales.

En el siguiente cuadro se describe las acciones realizadas y enunciados de conclusiones por parte del grupo, que permiten sustentar el haber alcanzado el logro del ABET – EAC - Student Outcome 4.

| Criterio específico | Acciones realizadas                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Conclusiones |
| :--- |:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| :--- |
| Reconoce responsabilidad ética y profesional en situaciones de ingeniería de software. | **Cacho Seminario, Diego Alonso**<br>TB1: Preparé el reporte principal y documentos de participación.<br>TP: Aporté con el Acuerdo de Servicios SaaS y correcciones de entregas pasadas.<br>TB2: Elaboré el Capítulo VIII, tarjetas de experimentos, historias To-Be y actualización del Acuerdo de Servicio SaaS.<br>TF: Realicé la auditoría cruzada interna, asegurando el cumplimiento de la rúbrica y la ética profesional en la revisión técnica.<br><br>**Villugas Jeronimo, Liam Anderson**<br>TB1: Aporte con el informe inicial.<br>TP: Soporte técnico y documentación de buenas prácticas.<br>TB2: Contribuí en la construcción del Capítulo VIII y revisión de privacidad de datos.<br>TF: Realicé la comprobación de la hipotesis 3 con lighthouse y realice la seccion de continius learning<br><br>**Ruiz Huisa, Daniel Elias**<br>TB1: Revisión de regresión de versiones desplegadas.<br>TP: Gestión del cumplimiento de ítems del backlog en el despliegue.<br>TB2: Racionalización de experimentos y alternativas de solución.<br>TF: Ejecuté el despliegue final y la verificación de estabilidad del sistema en el entorno de producción.<br><br>**Palacin Lazo, Gerardo Valentin**<br>TB1: Apoyo en la verificación y despliegue de información.<br>TP: Verificación y validación del product backlog y pruebas automatizadas.<br>TB2: Aplicación de la metodología XDPD en experiment cards.<br>TF: Coordiné la matriz de impacto ético y la síntesis final de resultados. Además, aprendí del impacto de las herramientas de experimentación y análisis de datos para la resolución de un proyecto empresarial y su monitoreo continuo. | En la TB1, el equipo revisó el avance general y realizó ajustes técnicos. <br><br>En el TP, corregimos los hallazgos previos y desplegamos el ecosistema completo (Landing, Frontend, Backend).<br><br>En la TB2, planificamos experimentos (Capítulo VIII) con una evaluación objetiva y segura.<br><br>En el TF, consolidamos el ciclo de vida del proyecto bajo estándares éticos, asegurando transparencia en la auditoría interna y validez en los resultados experimentales. |
| Emite juicios informados considerando el impacto de las soluciones de ingeniería de software en contextos globales, económicos, ambientales y sociales. | **Cacho Seminario, Diego Alonso**<br>TB1: Uso de herramientas GitHub y Canva.<br>TP: Adición de Selenium para pruebas de Frontend.<br>TB2: Justifiqué el uso de métricas (Lighthouse) para evaluar accesibilidad y rendimiento.<br>TF: Elaboré la Matriz de Evaluación Ética y de Impacto, analizando el impacto ambiental y social del sistema.<br><br>**Villugas Jeronimo, Liam Anderson**<br>TB1: Uso de herramientas de control de versiones.<br>TP: Implementación de pruebas automatizadas y Selenium.<br>TB2: Incorporación de métricas de negocio para medir el impacto de las mejoras.<br>TF: Analicé el impacto de la solución en contextos económicos globales y aseguré la robustez del sistema.<br><br>**Ruiz Huisa, Daniel Elias**<br>TB1: Identificación de puntos de desarrollo clave.<br>TP: Validación de la implementación de features en el backlog.<br>TB2: Evaluación técnica de la viabilidad de experimentos.<br>TF: Evalué el impacto de las hipotesis en los cuestionarios, determinando que aprendimnos de ellas y la siguiente acción que hacer.<br><br>**Palacin Lazo, Gerardo Valentin**<br>TB1: Documentación de avances mediante commits.<br>TP: Pruebas de flujo frontend con Selenium.<br>TB2: Captura y verificación de datos de hipótesis.<br>TF: Sinteticé las evidencias de impacto social y ético de la plataforma SafeWork para la entrega final. Además evalué el impacto de la fusión de los cambios del entorno experimental con el producto desplegado, aplicando herramientas de análisis como AWS RedLine y herramienta de IA como Firebase Studio para simular el flujo del sistema.                              | Durante la TB1, utilizamos GitHub para el control de versiones y gestión documental.<br><br>En el TP, integramos nuevas herramientas como Selenium para asegurar la calidad técnica.<br><br>En la TB2, establecimos KPIs y herramientas de análisis para medir el impacto empírico.<br><br>En el TF, el equipo concluyó que la solución tiene un impacto positivo al automatizar la gestión de seguridad laboral, optimizando recursos económicos y fomentando una cultura de prevención ética mediante decisiones basadas en datos. |
