...
| :--------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Reconoce responsabilidad ética y profesional en situaciones de ingeniería de software.       | **Cacho Seminario, Diego Alonso**<br>TB1: Para el desarrollo de la TB1, aporte creando los documentos de exposicion, reporte de participación y además prepare el reporte principal con los items anteriores para la entrega. <br><br>**###########, ###############**<br>TB1: .<br><br>**########, #######**<br>TB1: .<br><br>**#######, #########**<br>TB1: .<br><br>  | En la TB1, los integrantes del equipo revisaron el avance general de la entrega anterior y realizaron cambios para el funcionamiento aceptable de la aplicación.  <br><br>                                                                           |
| Emite juicios informados considerando el impacto de las soluciones de ingeniería de software en contextos globales, económicos, ambientales y sociales. | **Cacho Seminario, Diego Alonso**<br>TB1: Como primera entrega utilice las herramientas de Github y Canva para poder redactar y crear la información necesaria para el trabajo de SafeWork. <br><br>**#######, ########**<br>TB1: .<br><br>**########, ########**<br>TB1: .<br><br>**##########, ########**<br>TB1: .                                                           | Durante la TB1, el equipo logró utilizar las herramientas apropiadas para la entrega, se uso GitHub como repositorio principal para el proyecto, Google Docs para el reporte de participación y Canva como herramienta para crear la presentación de exposición. <br><br>|
